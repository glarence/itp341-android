...
package itp341.zhao.glarence.a9.database;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_POWERS =
            "CREATE TABLE " +
                    ...
                    DbSchema.TABLE_POWERS.KEY_ID + " integer primary key autoincrement, " +
                    DbSchema.TABLE_POWERS.KEY_OWN_POWER + " TEXT, " +
                    DbSchema.TABLE_POWERS.KEY_OPPOSING_POWER + " TEXT, " +
                    DbSchema.TABLE_POWERS.KEY_WINNING_POWER + " REAL " +
                    ");";

    private static final String CREATE_TABLE_HEROES =
            "CREATE TABLE " +
                    DbSchema.TABLE_HEROES.NAME + " (" +
                    DbSchema.TABLE_HEROES.KEY_ID + " integer primary key autoincrement, " +
                    DbSchema.TABLE_HEROES.KEY_NAME + " TEXT, " +
                    DbSchema.TABLE_HEROES.KEY_POWER1 + " TEXT, " +
                    DbSchema.TABLE_HEROES.KEY_POWER2 + " TEXT, " +
                    DbSchema.TABLE_HEROES.KEY_NUM_WINS + " REAL, " +
                    DbSchema.TABLE_HEROES.KEY_NUM_LOSSES + " REAL, " +
                    DbSchema.TABLE_HEROES.KEY_NUM_TIES + " REAL" +
                    ");";
